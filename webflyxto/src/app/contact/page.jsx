      ...
      <Container>
        <div className='relative'>
          <div className='grid grid-cols-2'>
            ...
            <div className=''>
              <motion.div
                className='relative z-10 mt-56 text-center'
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.75 }}
              >
                <p className='text-5xl font-semibold gradient-text'>Schedule a Meeting</p>
                <p>Time Made Simple: Book Your Meetings in Seconds!</p>
                <a
                  href="#"
                  onClick={handleCalendlyClick}
                  
                >
                  <Button className="mt-6  bg-black/50 text-white text-lg px-8 py-4 rounded-full shadow-md scale-125">Schedule Here</Button>
        ...
        <div className='grid grid-cols-2'>
          <div className='z-10 relative mt-24 flex items-center justify-center '>
            <div className=' backdrop-blur-sm p-8 rounded-2xl shadow-lg'>
              <motion.div
                className=' flex justify-center scale-75'
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className='z-10 relative mt-24 flex  justify-center'
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.5 }}
          >

            <div className='w-full p-8  mt-3 pb-24 bg-black/40 backdrop-blur-sm rounded-3xl rounded-tr-[100px] rounded-bl-[100px] shadow-lg'>
              <p className='text-4xl gradient-text text-center font-semibold'>Any Questions ?</p>
              <form onSubmit={handleSubmit}>
                ...
                <div className='mt-4'>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    required
                    className='mt-1 block bg-white/20 w-full h-32 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'
                  />
                </div>
                <div className='mt-6'>
                  <Button type="submit" className='w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-white/30 hover:bg-white/40 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white/80'>
                    Send
                  </Button>
                </div>
