...
const Navbar2 = () => {
  ...
  return (
    <header className={`sticky top-5 z-50 ${styles.header}`}>
      <nav className="z-10 w-full">
        <div className='max-w-7xl mx-auto px-6 md:px-12 xl:px-6'>
          <div className={`flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 rounded-full md:bg-white/10 backdrop-blur-lg ${styles.nav}`}>
