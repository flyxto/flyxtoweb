...
const Footer = () => {
  return (
    <div>
      <footer className="footer-sec overflow-clip shadow-2xl shadow-white z-50">
        <div className="main">
          ...
          <div className="office row">
            ...
            <div className="office-des">
              ...
              <a href="hello@flyxto.com">hello@flyxto.com</a>
              <p className="num">+94-703507170</p>
            </div>
          </div>
            ...
            <div className="flex justify-start">
              ...
              <div className="">
                ...
                <div class="social-icon twitter-icon ">
                  ...
                  <svg class="social-icon-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
