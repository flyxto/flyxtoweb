  ...
  return (
    <header className="w-full shadow-sm">
      <div className="container mx-auto flex h-16 max-w-7xl items-center justify-center px-4 md:px-6">
        <div className="flex items-center py-2 px-8 bg-gray-800 rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 shadow-slate-500 shadow-inner mt-8">
          ...
          <Link href="#" className="pl-16 py-2" prefetch={false}>
